...
<link rel="stylesheet" href="/Content/Stylesheets/css/animate.min.css">
<link rel="stylesheet" href="/Content/Stylesheets/css/wiwet.style.css">
    ...
    <nav class="header-main-nav hidden-xs">
        <div class="container">
            <ul class="nav">
                ...
                <!-- <li><a href="/Home/UIElements">UI Elements</a></li>
                <li><a href="/Home/BlankPage">Blank Page</a></li> -->
            </ul>
        </div>
...
<section class="home-page-slider">
    <div class="flexslider">
        <ul class="slides">
            <li>
                <div class="slide" data-background-image="/Content/Images/slide-1.png">
                    <article class="slide-content">
                        <div class="container">
                            <img src="/Content/Images/slide-1.jpg" alt="" class="sr-only">
            ...
            <li>
                <div class="slide" data-background-image="/Content/Images/slide-2.png">
                    <article class="slide-content">
                        <div class="container">
                            <img src="/Content/Images/slide-2.jpg" alt="" class="sr-only">
            ...
            <li>
                <div class="slide" data-background-image="/Content/Images/slide-3.png">
                    <article class="slide-content">
                        <div class="container">
                            <img src="/Content/Images/slide-3.png" alt="" class="sr-only">                            
            ...
            <li>
                <div class="slide" data-background-image="/Content/Images/slide-5.jpg">
                    <article class="slide-content">
                        <div class="container">
                ...
                <div class="row animate-multiple">
                    <div class="col-sm-4">
                        <div class="team-item" data-animation="fadeInLeft">
                            <img src="/Content/Images/user-1.png" alt="" class="thumbnail">
                    ...
                    <div class="col-sm-4">
                        <div class="team-item" data-animation="zoomIn">
                            <img src="/Content/Images/user-2.png" alt="" class="thumbnail">
                    ...
                    <div class="col-sm-4">
                        <div class="team-item" data-animation="fadeInRight">
                            <img src="/Content/Images/user-3.png" alt="" class="thumbnail">
                            <h4>Jhoset Ceron</h4>
...
<script src="/Content/Scripts/wiwet.template.js"></script>
